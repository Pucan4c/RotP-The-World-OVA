package com.pucan4c.rotp_otw.capability;
...
@Mod.EventBusSubscriber(modid = RotpOTWA.MOD_ID)
public class CapabilityHandler {
    private static final ResourceLocation TIME_STOP_UTIL_CAP = new ResourceLocation(RotpOTWA.MOD_ID, "time_stop_util");
    private static final ResourceLocation LIVING_UTIL_CAP = new ResourceLocation(RotpOTWA.MOD_ID, "living_util");
